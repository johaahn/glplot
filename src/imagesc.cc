...
GLfloat af_rgb_jet[][3] = {
{0,0,0.5},
{0,0,0.5634920634920635},
{0,0,0.626984126984127},
{0,0,0.6904761904761905},
{0,0,0.753968253968254},
{0,0,0.8174603174603174},
{0,0,0.8809523809523809},
{0,0,0.9444444444444444},
{0,0.007936507936507908,1},
{0,0.0714285714285714,1},
{0,0.1349206349206349,1},
{0,0.1984126984126984,1},
{0,0.2619047619047619,1},
{0,0.3253968253968254,1},
{0,0.3888888888888888,1},
{0,0.4523809523809523,1},
{0,0.5158730158730158,1},
{0,0.5793650793650793,1},
{0,0.6428571428571428,1},
{0,0.7063492063492063,1},
{0,0.7698412698412698,1},
{0,0.8333333333333333,1},
{0,0.8968253968253967,1},
{0,0.9603174603174602,1},
...
{0.9761904761904763,1,0.02380952380952372},
{1,0.9603174603174605,0},
{1,0.8968253968253972,0},
{1,0.8333333333333335,0},
{1,0.7698412698412698,0},
{1,0.7063492063492065,0},
{1,0.6428571428571432,0},
{1,0.5793650793650795,0},
{1,0.5158730158730158,0},
{1,0.4523809523809526,0},
{1,0.3888888888888893,0},
{1,0.3253968253968256,0},
{1,0.2619047619047619,0},
{1,0.1984126984126986,0},
{1,0.1349206349206353,0},
{1,0.07142857142857162,0},
{1,0.007936507936507908,0},
{0.9444444444444446,0,0},
{0.8809523809523814,0,0},
{0.8174603174603177,0,0},
{0.753968253968254,0,0},
{0.6904761904761907,0,0},
{0.6269841269841274,0,0},
{0.5634920634920637,0,0},
{0.5,0,0}};
...
void imagesc::f_gl_update(double & in_f_min_x,double & in_f_max_x,double & in_f_min_y,double & in_f_max_y,double & in_f_min_z,double & in_f_max_z) {
	in_f_min_x = 0.0;
	in_f_max_x = 1.0;
	in_f_min_y = 0.0;
	in_f_max_y = 1.0;
...
void imagesc::f_gl_render_scaled(void) {
	...
	if(_i_data_update != _i_tbo_update) {
		...
		glBufferData(GL_TEXTURE_BUFFER_EXT, _sz_colormap * 3 * sizeof(GLfloat), _af_colormap, GL_STATIC_READ);
	...
	glUseProgram(_i_shader_program);
	{
		...
		cout << "EXTREM2 " << _f_max << " " << _f_min <<endl;
		/* Load shaders params */
		{
...
void imagesc::f_gl_init(void) {
	...
	_i_uniform_i_colormap_tbo = glGetUniformLocation(_i_shader_program, "t_colormap");
	...
	_i_uniform_sz_colormap = glGetUniformLocation(_i_shader_program, "i_sz_colormap");
}
